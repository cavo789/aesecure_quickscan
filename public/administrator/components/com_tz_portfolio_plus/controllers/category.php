 ...
 */
class TZ_Portfolio_PlusControllerCategory extends JControllerForm
{
	/**
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$this->setRedirect('index.php?option=com_tz_portfolio_plus&view=categories&extension=' . $this->extension);
...
//		$append .= '&extension=' . $this->extension;
    ...
    function extrafields(){
        $model  = $this -> getModel('Category','TZ_Portfolio_PlusModel');
