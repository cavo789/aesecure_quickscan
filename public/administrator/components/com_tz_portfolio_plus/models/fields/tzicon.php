 ...
 * @since       11.1
 */
class JFormFieldTZIcon extends JFormField
{
    ...
    protected function getInput()
    {
        ...
        $document->addScript(JUri::root().'/media/tz_portfolio_plus/fonticonpicker/js/jquery.fonticonpicker.min.js', array('version' => '3.1.1'));
