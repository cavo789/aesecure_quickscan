...
ob_start();
?>
<form action="index.php?option=com_tz_portfolio_plus" method="post" name="adminForm" class="adminForm tpp-dialog__reject">
...
echo JHtml::_(
    ...
    $modalId,
    array(
        'title'      => JText::_('COM_TZ_PORTFOLIO_REJECT_ARTICLE'),
        'width'      => '100%',
        'height'     => '500px',
        'modalWidth' => '40',
        'closeButton' => true,
