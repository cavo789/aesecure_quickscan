...
if(isset($this -> item) && $this -> item){
    ...
    if($params -> get('show_cat_vote', 0)){
        ...
        if(!$this -> head['layout_'.$this -> getLayout()]) {
            ...
            (function($){
                ...
                $(document).ready(function(){
                    $(".js-tpp-addon-vote__date").tzPortfolioPlusAddOnVote({
                        mainSelector: ".js-tpp-addon-vote__date",
        ...
        <div class="content_rating muted text-muted js-tpp-addon-vote__date"  itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating">
