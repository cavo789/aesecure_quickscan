...
echo JHtml::_(
    ...
    $modalId,
    array(
        'title'      => JText::_('COM_TZ_PORTFOLIO_PLUS_APPROVE_ARTICLE'),
        'width'      => '100%',
        'height'     => '500px',
        'modalWidth' => '40',
        'closeButton' => true,
        ...
        'footer'      => '<a class="btn btn-default" data-dismiss="modal" href="javascript:void(0);">'
            ...
            . JText::_('COM_TZ_PORTFOLIO_PLUS_APPROVE') . '</a>',
    ),
    JText::_('COM_TZ_PORTFOLIO_PLUS_DIALOG_CONFIRM_APRROVE_CONTENT')
);
?>