...
<div class="form-horizontal">
    <?php
    echo JHtml::_('bootstrap.startAccordion', 'tp-ac-edit__fields',
    ...
    <?php
        foreach($fieldGroups as $i => $group) {
            ...
            if ($fields = $group->fields) {
                if(count($fields)) {
                    // Start accordion
                    echo JHtml::_('bootstrap.addSlide', 'tp-ac-edit__fields', ucwords($group -> name), 'tp-ac-edit__f-collapse' . ($i));
