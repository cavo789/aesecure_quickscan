 ...
 * @since  1.0
 */
class ADatabaseQuerySqlite extends ADatabaseQuery implements ADatabaseQueryLimitable, ADatabaseQueryPreparable
{
	/**
	 ...
	 *
	 * @return  ADatabaseQuerySqlite  Returns this object to allow chaining.
	 *
	 * @since   1.0
	 */
