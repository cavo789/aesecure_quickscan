...
$vars = [
    ...
    'grid', 'grid_divider', 'cols','tooltip','circle','img_popup', 'cols_all', 'cols_s', 'cols_m', 'cols_l', 'cols_xl',
    'items'
];
...
if ($items) {
    require(ModuleHelper::getLayoutPath('mod_uk_counter', $params->get('layout', 'default')));
}
