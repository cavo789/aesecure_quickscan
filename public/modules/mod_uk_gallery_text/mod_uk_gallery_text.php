...
$vars = [
    ...
    'grid', 'grid_divider', 'grid_center','link_popup','show_tags','link_target','animation', 'cols', 'cols_all', 'cols_s', 'cols_m', 'cols_l', 'cols_xl', 'masonry','content_class',
    'items'
];
...
if ($items) {
    ...
    $tagsList = ModUkGalleryTextHelper::getTagsList($items);    
    require(ModuleHelper::getLayoutPath('mod_uk_gallery_text', $params->get('layout', 'default')));
}