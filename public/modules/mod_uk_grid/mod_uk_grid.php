...
$vars = [
    ...
    'grid', 'grid_divider', 'grid_center','grid_center','link_popup','show_tags','link_target', 'cols', 'cols_all', 'cols_s', 'cols_m', 'cols_l', 'cols_xl', 'masonry','parallax','items'
];
...
if ($items) {
    ...
    $tagsList = ModUkGridHelper::getTagsList($items);    
