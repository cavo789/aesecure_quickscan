...
$vars = [
    'grid_class', 'item_class','item_style','tags','margin_class', 'first_column_class', 'show_tags','height_match', 'height_match_class',
    'grid', 'grid_divider', 'grid_center','modal_popup','img','modal_id','overlay_style','link_popup', 'cols', 'cols_all', 'cols_s', 'cols_m', 'cols_l', 'show_tags','cols_xl', 'masonry','modal_typ','modal_img','items'
];
...
if ($items) {
    ...
    $tagsList = ModGridPortfolioHelper::getTagsList($items);    
    require(ModuleHelper::getLayoutPath('mod_uk_grid_portfolio', $params->get('layout', 'default')));
}