...
$vars = [
    ...
    'grid', 'grid_divider', 'cols','tooltip','circle','img_popup', 'cols_all', 'link_target','cols_s', 'cols_m', 'cols_l', 'cols_xl',
    'items'
];
...
if ($items) {
    require(ModuleHelper::getLayoutPath('mod_uk_pricetable', $params->get('layout', 'default')));
}
