...
/*
 * @package     mod_uk_slide_portfolio
...
$vars = [
    'slider_class', 'item_class', 'show_tags','item_style','dotnav', 'slidenav','velocity', 'autoplay', 'autoplay_interval', 'finite', 'pause_on_hover', 'index', 'center', 'sets','grid', 'grid_divider', 'cols','tooltip','circle', 'cols_all', 'cols_s', 'cols_m', 'cols_l', 'modal_typ','cols_xl','modal_id','modal_img',
    'items'
];
...
if ($items) {
    ...
    $tagsList = ModGridSlidePortfolioHelper::getTagsList($items);    
    require(ModuleHelper::getLayoutPath('mod_uk_slide_portfolio', $params->get('layout', 'default')));
}