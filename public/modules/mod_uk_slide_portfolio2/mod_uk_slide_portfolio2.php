...
/*
 * @package     mod_uk_slide_portfolio2
...
$vars = [
    'slider_class', 'item_class', 'item_style','dotnav', 'slidenav','velocity', 'autoplay', 'autoplay_interval', 'finite', 'pause_on_hover', 'index', 'center', 'sets','grid', 'grid_divider', 'cols','tooltip','circle', 'cols_all', 'cols_s', 'cols_m', 'cols_l', 'cols_xl',
    'items'
];
...
if ($items) {
    require(ModuleHelper::getLayoutPath('mod_uk_slide_portfolio2', $params->get('layout', 'default')));
}