...
$vars = [
    'item_style','dotnav', 'slidenav',
    'velocity', 'autoplay', 'autoplay_interval', 'finite', 'pause_on_hover', 'index', 'center', 'sets',
    'grid', 'grid_divider', 'cols', 'img_width','media_align','img_height','item_count','item_space','tooltip','lightbox', 'cols_all', 'cols_s', 'cols_m', 'cols_l', 'cols_xl',
    'items'
];
...
if ($items) {
    require(ModuleHelper::getLayoutPath('mod_uk_switcher', $params->get('layout', 'default')));
}
