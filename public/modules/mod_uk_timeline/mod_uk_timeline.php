...
$vars = [
    ...
    'grid', 'grid_divider', 'cols','timelinecolor','timeline_bg','timeline_color','date','tooltip','circle','img_popup', 'cols_all', 'cols_s', 'cols_m', 'cols_l', 'cols_xl',
    'items'
];
...
if ($items) {
    require(ModuleHelper::getLayoutPath('mod_uk_timeline', $params->get('layout', 'default')));
}
